...
\newtcbtheorem[number within=section]{Example}{Példa}
{%
	colback = myexamplebg
	,breakable
...
\newtcbtheorem[number within=chapter]{example}{Példa}
{%
	colback = myexamplebg
	,breakable
	,colframe = myexamplefr
...
\newtcbtheorem[number within=section]{Definition}{Definíció}{enhanced,
	...
	fonttitle=\bfseries,
	title={#2},#1}{def}
\newtcbtheorem[number within=chapter]{definition}{Definíció}{enhanced,
	before skip=2mm,after skip=2mm, colback=red!5,colframe=red!80!black,boxrule=0.5mm,
	attach boxed title to top left={xshift=1cm,yshift*=1mm-\tcboxedtitleheight}, varwidth boxed title*=-3cm,
	boxed title style={frame code={
					\path[fill=tcbcolback]
...
\newcommand{\kikot}[1]{\begin{kikotes}#1\end{kikotes}}
...
\renewcommand{\tableofcontents}{%
	\chapter*{%
	  \vspace*{-20\p@}%
	  \begin{tikzpicture}[remember picture, overlay]%
		  \pgftext[right,x=15cm,y=0.2cm]{\color{doc!60}\Huge\sc\bfseries Tartalomjegyzék};% 
		  \draw[fill=doc!60,draw=doc!60] (13,-.75) rectangle (20,1);%
		  \clip (13,-.75) rectangle (20,1);
		  \pgftext[right,x=15cm,y=0.2cm]{\color{white}\Huge\sc\bfseries Tartalomjegyzék};%
	  \end{tikzpicture}}%
	\@starttoc{toc}}
\makeatother
...
\newcommand{\mytitleb}[4]{\begin{tikzpicture}[overlay,remember picture]
		...
		{
			{\fontsize{25}{30} \selectfont \bf  Órai\\[10pt] Jegyzet}
		} 
		node[
		midway,
		right=0.25cm,
